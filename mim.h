//------------------------------------------------------+----------------------
// МикроМир07 Main Header + Scrollable/Gradient Window  | (c) Epi MG, 2004-2022
//------------------------------------------------------+----------------------
...
#endif            //
  void onFocus(); // used for run1instance case only
};
...
#endif
//-----------------------------------------------------------------------------
enum MiInfoType { MitUSE_CURRENT = 0, MitLINE_BLOCK = 1, MitCHARK = 3,
                                      MitLINE_POSXY = 2, MitKBKEY = 4 };
